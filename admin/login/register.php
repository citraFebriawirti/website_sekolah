...
<body class="bg-gradient-login">
    ...
    <div class="bg-light py-3 py-md-5 bg-image">
        <div class="container">
                ...
                <div class="col-12 col-md-11 col-lg-8 col-xl-7 col-xxl-6">
                    <div class="bg-white p-4 p-md-5 rounded shadow-md">
                        ...
                        <form action="proses_register.php" enctype="multipart/form-data" method="post">
                            <div class="row gy-3 gy-md-4 overflow-hidden mt-3">
                                <div class="col-6">
                                ...
                                <div class="col-6">
                                    <label for="nama_lengkap" class="form-label">Gambar <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="d-flex gap-2 gap-md-4 flex-column flex-md-row justify-content-md-center">
                                    <a href="index.php" class="link-secondary text-decoration-none">Masuk</a>
