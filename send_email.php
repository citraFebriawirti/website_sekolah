...
$nama_pengirim = $_POST['name']; // Mengubah nama variabel untuk sesuai dengan form
$email = $_POST['email'];
$judul = $_POST['subject']; // Mengubah nama variabel untuk sesuai dengan form
$isi_pesan = $_POST['message']; // Mengubah nama variabel untuk sesuai dengan form
...
if ($tambah) {
    ...
    try {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'ecommercethriftbyte@gmail.com'; // Ganti dengan email SMTP Anda
        $mail->Password   = 'bdag ctxd vyau cotv';    // Ganti dengan password SMTP Anda
        ...
        $mail->addAddress('ecommercethriftbyte@gmail.com'); // Penerima email
        ...
        <div style='font-family: Arial, sans-serif; color: #333; background-color: #f9f9f9; padding: 20px; border: 1px solid #ddd;'>
            ...
            <p style='font-size: 16px;'><strong>Pesan:</strong> $isi_pesan</p>
